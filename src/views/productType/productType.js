    ...
    fetch(`${apiURL}/api/productType/${id}`, {
      ...
      .then((res) => {        
        if (res.ok) {
          ...
          showNotf(false, `${res.status}: An error occurred while deleting Product Type`);
          return res.json().then(err =>{
            console.error(err);
          })
        }
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              You can add, update and delete <i>Product Type</i>
            </p>
            ...
            <CModal scrollable visible={modalVisible} onClose={() => closeModal()} className='infoModal'>
              <CModalHeader>
                <CModalTitle>Product Type</CModalTitle>
              </CModalHeader>
              <CModalBody>
            ...
            >
              ...
              <CModalBody>
                Do you want to delete <strong>{selectedData?.slug}</strong> Product Type? 
              </CModalBody>
              <CModalFooter>
