    ...
    fetch(`${apiURL}/api/banner/${id}`, {
      ...
      .then((res) => {        
        if (res.ok) {
          ...
          showNotf(false, `${res.status}: An error occurred while deleting banner`);
          return res.json().then(err =>{
            console.error(err);
          })
        }
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              You can add, update and delete <i>Banners</i>
            </p>
            ...
            <CModal scrollable visible={modalVisible} onClose={() => closeModal()} className='infoModal'>
              <CModalHeader>
                <CModalTitle>Banner</CModalTitle>
              </CModalHeader>
              <CModalBody>
                ...
                <div className='infoModal__item'>
                  <strong> Image </strong>
                  {
                    ...
                    <div className='infoModal__item--image'>
                      <img src={selectedData?.image} alt={selectedData?.page}/>
                    </div> :
            ...
            >
              ...
              <CModalBody>
                Do you want to delete <strong>{selectedData?.page}</strong> Banner image? 
              </CModalBody>
              <CModalFooter>
